"""Lancet offline-to-online registration (state observations in v1)."""
from dataclasses import dataclass
from typing import Literal

from rl_garden.common.env_args import EnvBackendArgs
from rl_garden.training.inspection import construct_agent
from rl_garden.training.off2on._args import VisionWSRLTrainingArgs, initial_training_phase_from_args
from rl_garden.training.off2on._registry import registry


@dataclass
class LancetOff2OnArgs(VisionWSRLTrainingArgs, EnvBackendArgs):
    """Lancet critic correction. v1 is intentionally flat-state only."""
...
def build_lancet(args: LancetOff2OnArgs, env, eval_env, logger, checkpoint_dir):
    ...
    agent = construct_agent(
        ...
        net_arch={"pi": [args.hidden_dim] * args.actor_hidden_layers, "qf": [args.hidden_dim] * args.critic_hidden_layers},
