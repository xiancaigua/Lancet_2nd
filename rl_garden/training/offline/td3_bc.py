...
class TD3BCArgs(
    ...
    """TD3-BC offline pretraining. Box or Dict (vision) observations."""
...
def build_td3_bc(args, env_spec, logger, eval_env=None):
    ...
    return construct_agent(TD3BC, **_td3_bc_kwargs(args, env_spec, logger, eval_env))
...
def _td3_bc_algorithm_cls() -> type:
    from rl_garden.algorithms import TD3BC

    return TD3BC


registry.register("td3_bc", TD3BCArgs, run_td3_bc, algorithm_cls=_td3_bc_algorithm_cls)
