"""FINO offline pretraining registration."""
...
class FINOArgs(
    ...
    """FINO offline pretraining. Box or Dict (vision) observations."""
...
def build_fino(args, env_spec, logger, eval_env=None):
    from rl_garden.algorithms import FINO
    from rl_garden.training.inspection import construct_agent

    return construct_agent(FINO, **_fino_kwargs(args, env_spec, logger, eval_env))


def run_fino(args: FINOArgs) -> None:
